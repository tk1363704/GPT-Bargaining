...
def define_arguments():
    ...
    # moderator arguments
    parser.add_argument('--moderator_instruction', type=str, default="moderator_0509",
    ...
    # game arguments
    parser.add_argument('--game_type', type=str, default='criticize_seller',
...
if __name__ == "__main__":
    ...
    game_version = '{}_{}_{}_runs_{}_rollout_ver_{}'.format(args.seller_instruction, args.game_type, args.n_exp, args.n_rollout, args.ver)
